...
def main():
    ...
    # Tangent at post-trade point
    slope_post = -x_new / y_new
    y_tan_post = np.array([y_new - dy_tan, y_new + dy_tan])
    x_tan_post = x_new + slope_post * (y_tan_post - y_new)
    ax.plot(
        y_tan_post, x_tan_post,
        color="darkviolet",
        lw=1.2,
        ls="--",
        zorder=5,
        label="Tangent line (post-trade)"
    )
